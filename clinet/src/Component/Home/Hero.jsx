...
import pic from "./image/Logo.jpeg";
...
const Hero = () => {
  return (
    ...
    >
      <div className="carousel tw-pt-0 tw-mb-12 sm:tw-pb-0 ">
        <div className="tw-hidden lg:tw-block ">
          <div className="carousel-content">
            <motion.h1 variants={fadeIn("up", "tween", 0.2, 1)}>
              Karamon Design Studio
            </motion.h1>
            <hr />
            <motion.p variants={fadeIn("up", "tween", 0.5, 1.2)}>
            ...
            <div className="flex-row font-bold text-2xl">
              <div className='slider-btn'>
                <motion.span
                  variants={fadeIn("up", "tween", 0.9, 1.3)} 
                >
                  <CountUp start={-7} end={26} duration={10} />
              ...
              <div className='slider-btn'>
                <motion.span
                  ...
                  className=''
                >
                  <CountUp start={-7} end={7} duration={10} />
                  <span className=" mr-4">+</span>
                  Running Project
                </motion.span>
              </div>
...
{/* 
        <img src={pic} alt="bg image" className="bgdonut1" />
        <img src={pic} alt="bg image" className="bgdonut2" /> */}
      </div>
    </motion.div>
  );
};
